...
public class RandomSpawner : MonoBehaviour
{
    ...
    [SerializeField] private float _sectoreRotation;
    ...
    {
        var angleMiddleDelta = (180 - _sectoreRotation - _sectorAngle) / 2;
    ...
    private void OnDrawGizmos()
    {
        ...
        var middleAngleDelta = (180 - _sectoreRotation - _sectorAngle) / 2;
