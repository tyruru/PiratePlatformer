...
public class InfiniteBackgroundComponent : MonoBehaviour
{
    ...
    private Vector3 _bounceToTransformDelta;
    ...
    private void Start()
    {
        ...
        _bounceToTransformDelta = transform.position - _allBounds.center;
    ...
    private void LateUpdate()
    {
        ...
        _allBounds.center = transform.position - _bounceToTransformDelta;
